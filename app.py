...
model = pickle.load(open('/content/drive/My Drive/Machine_Learning/Lab/Exp06/svmmodel.pkl', 'rb')) 
model_randomforest = pickle.load(open('/content/drive/My Drive/Machine_Learning/Lab/Exp06/randomforest.pkl', 'rb')) 
dataset= pd.read_csv('/content/drive/My Drive/Machine_Learning/Lab/Exp06/Social_Network_Ads.csv')
